...
<body id="cuerpo">
    <table id="tabladatos">
        <thead>
            <tr>
                <br><td colspan="5" id="lista"><h3><br>Detalle de administrador</h3></td><br>
            </tr>
            <tr>
                <br><td colspan="5" id="lista"><a href="administradores_lista.php"><h3>Regresar al listado</h3></a></td><br>
            </tr>
            <tr>
        ...
        <tbody>
            ...
            while($row = $res->fetch_array()){
                ...
                $correo   = $row["correo"];
                $rol      = $row["rol"];
                $rol_txt = ($rol == 1) ? 'Ejecutivo' : 'Gerente';
                $status      = $row["status"];
