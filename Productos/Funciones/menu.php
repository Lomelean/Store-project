...
?>    
    <table id="datatable">
        <tbody>
               ...
               <td id="cells" style="background-color:hsl(180,40%,70%);"><a href="../Administrador/administradores_lista.php">ADMINISTRADORES</a></td>
               <td id="cells" style="background-color:hsl(190,50%,70%);"><a href="productos_lista.php">PRODUCTOS</a></td>
               <td id="cells" style="background-color:hsl(180,40%,70%);"><a href="../Banners/banners_lista.php">BANNERS</a></td>   
               <td id="cells" style="background-color:hsl(190,50%,70%);"><a href="../Administrador/administradores_pedidos.php">PEDIDOS</a></td>
